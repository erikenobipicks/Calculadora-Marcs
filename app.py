...
ALBUM_PRICING = {
    ...
    'extras': [
        {'id': 'uvi',     'label': 'Gravació UVI',  'price': 6.0, 'qty': True},
        {'id': 'pintura', 'label': 'Pintura caixa', 'price': 3.0},
    ],
    # Extres dels packs: 'sheet_price' = plec/full addicional (segons la mida del
    # pack); 'replica_price' = rèplica de pares addicional (30×30→20×20 = 70 €,
    # 30×40→20×30 = 80 €, coherent amb la diferència sol↔rèpliques dels packs).
    'wedding_packs': [
        {'id': 'boda_30x30_sol',              'label': 'Boda 30×30 sol (30 plecs, UVI, caixa foto)',            'price': 239.00, 'sheet_price': 6.90, 'replica_price': 70.0, 'replica_label': '20×20'},
        {'id': 'boda_30x30_repliques',        'label': 'Boda 30×30 + 2 rèpliques pares 20×20',                  'price': 379.00, 'sheet_price': 6.90, 'replica_price': 70.0, 'replica_label': '20×20'},
        {'id': 'boda_30x30_fusta',            'label': 'Boda 30×30 + caixa de fusta',                           'price': 274.00, 'sheet_price': 6.90, 'replica_price': 70.0, 'replica_label': '20×20'},
        {'id': 'boda_30x30_fusta_repliques',  'label': 'Boda 30×30 + fusta + 2 rèpliques 20×20',                'price': 414.00, 'sheet_price': 6.90, 'replica_price': 70.0, 'replica_label': '20×20'},
        {'id': 'boda_30x40_sol',              'label': 'Boda 30×40 sol (30 plecs, UVI, caixa foto)',            'price': 265.00, 'sheet_price': 8.95, 'replica_price': 80.0, 'replica_label': '20×30'},
        {'id': 'boda_30x40_repliques',        'label': 'Boda 30×40 + 2 rèpliques pares 20×30',                  'price': 425.00, 'sheet_price': 8.95, 'replica_price': 80.0, 'replica_label': '20×30'},
        {'id': 'boda_30x40_fusta',            'label': 'Boda 30×40 + caixa de fusta',                           'price': 305.00, 'sheet_price': 8.95, 'replica_price': 80.0, 'replica_label': '20×30'},
        {'id': 'boda_30x40_fusta_repliques',  'label': 'Boda 30×40 + fusta + 2 rèpliques 20×30',                'price': 465.00, 'sheet_price': 8.95, 'replica_price': 80.0, 'replica_label': '20×30'},
    ],
    'communion_packs': [
        {'id': 'flop_25_15', 'label': 'Flop 25|15 · Libreto 25×25 (7 f.) + caixa + mini 15×15', 'price': 87.00,  'sheet_price': 4.48},
        {'id': 'flop_25_20', 'label': 'Flop 25|20 · Libreto 25×25 (7 f.) + caixa + mini 20×20', 'price': 104.00, 'sheet_price': 4.48},
        {'id': 'flop_30_15', 'label': 'Flop 30|15 · Libreto 30×30 (7 f.) + caixa + mini 15×15', 'price': 110.00, 'sheet_price': 6.90},
        {'id': 'flop_30_20', 'label': 'Flop 30|20 · Libreto 30×30 (7 f.) + caixa + mini 20×20', 'price': 126.00, 'sheet_price': 6.90},
        {'id': 'jack_25_15', 'label': 'Jack 25|15 · Àlbum 25×25 (7 f.) + caixa + mini 15×15',   'price': 100.00, 'sheet_price': 4.48},
        {'id': 'jack_25_20', 'label': 'Jack 25|20 · Àlbum 25×25 (7 f.) + caixa + mini 20×20',   'price': 104.00, 'sheet_price': 4.48},
        {'id': 'jack_30_15', 'label': 'Jack 30|15 · Àlbum 30×30 (7 f.) + caixa + mini 15×15',   'price': 133.00, 'sheet_price': 6.90},
        {'id': 'jack_30_20', 'label': 'Jack 30|20 · Àlbum 30×30 (7 f.) + caixa + mini 20×20',   'price': 126.00, 'sheet_price': 6.90},
    ],
}
